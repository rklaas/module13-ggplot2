...
ggplot(data = diamonds.sample) +
  geom_point(mapping = aes(x = carat, y = price, shape = cut, size = price))

# Try coloring the above plot based on the diamond's price!
ggplot(data = diamonds.sample) +
  geom_point(mapping = aes(x = carat, y = price, shape = cut, size = price, color = price))
...
ggplot(data = diamonds.sample) +
  geom_plot(mapping = aes(x = depth, fill = clarity))
